...
public class MovieController {
    ...
    public List<Movie> getMoviesByReleaseDate(@PathVariable("releaseDate") LocalDate releaseDate) throws ItemNotFoundException {return movieService.getMoviesByReleaseDate(releaseDate);}
